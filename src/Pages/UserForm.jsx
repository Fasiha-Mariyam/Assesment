...
const dummyStates = ['Alabama', 'Alaska', 'American Samoa', 'Arizona', 'Arkansas',
...
export default function UserForm() {
    ...
    const AddUser = (e) => {
        ...
        // Validation checks
        if (!Image || !email.trim() || !selectedCountry || !selectedState || !Name) {
        ...
        Swal.fire({
            ...
            text: 'The user has been added to the user table.',
            icon: 'success',
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-start text-dark mt-5 mb-4 rounded">
                <span className='fs-2'>User Form</span>
            </div>

          {/* From */}
            <Form onSubmit={AddUser} >
                  {/* upload Picture */}
                <div className='w-25 m-2 border border-dashed border-dark'>
                    <Form.Group controlId="imageUpload" className="text-secondary p-2 ">
                ...
                <small className='text-secondary m-2'>PNG,JPEG,JPG</small>
                ...
                <div className='container row mt-3'>
                    <div className='col-md-6'>
                        <div className='w-100'>
                                ...
                                <Form.Control placeholder="Enter username" value={Name}
                    ...
                    <div className='col-md-6'>
                        <div className='w-100'>
                            ...
                            <div className="mt-3 d-flex justify-content-end ">
                                <button className='btn btn-lg text-white ' style={myStyle} >
                                    Add User
                                </button>
                            </div>
                        </div>
